...
import (
	"github.com/emebit/goexperts-lab-auction/configuration/database/mongodb"
	"github.com/emebit/goexperts-lab-auction/internal/infra/api/web/controller/auction_controller"
	"github.com/emebit/goexperts-lab-auction/internal/infra/api/web/controller/bid_controller"
	"github.com/emebit/goexperts-lab-auction/internal/infra/api/web/controller/user_controller"
	"github.com/emebit/goexperts-lab-auction/internal/infra/database/auction"
	"github.com/emebit/goexperts-lab-auction/internal/infra/database/bid"
	"github.com/emebit/goexperts-lab-auction/internal/infra/database/user"
	"github.com/emebit/goexperts-lab-auction/internal/usecase/auction_usecase"
	"github.com/emebit/goexperts-lab-auction/internal/usecase/bid_usecase"
	"github.com/emebit/goexperts-lab-auction/internal/usecase/user_usecase"
	"context"
	"log"
